    ...
    function showCard(e){
      ...
      for (let i = 0; i < data.length; i++) {
                  ...
                  <div class="container">
                    <div class="row h-100">
                      <div class="col info fixed my-md-0 my-3">
                        ...
                        <div class="col overflow-auto bg-white border border-dark p-2 rounded tags" style="height:10vh">
                          123
                        </div>
                      </div>
                      <div class="user fixed my-md-0 my-3 p-2">
                        
                        <div class="row justify-content-end align-items-center flex-column flex-xl-row flex-nowrap">
                          <div class="col">
        ...
        for (let j = 0; j < tagAry.length; j++) {
          tagStr+= `<span class="badge badge-secondary mr-1">${tagAry[j]}</span>`
        }
