...
INSERT INTO `03_user_info` (`id`, `acc`, `name`, `info`, `favorite`, `following`) VALUES
(1, 'admin', '官方帳號', '我是官方帳號...', '', ''),
(2, 'test01', '測試帳號', '我是測試帳號...', '', '');
