...
INSERT INTO `01_account` (`id`, `acc`, `psw`, `name`, `info`, `img`) VALUES
(1, 'admin', '1234', ' official', ' official User', '');
...
(1, 'https://picsum.photos/1000/1200/', 'admin', '作品no.00', 'test 123 0001132', '門羅主義百年紀念半美元是美國鑄幣局生產的一種50美分面額硬幣，其正面刻有兩位前總統詹姆斯·門羅和約翰·昆西·亞當斯的頭像，旨在紀念門羅主義100周年，由舊金山鑄幣局在1923年鑄造。紀念幣由雕塑家切斯特·比奇設計。1922年，美國電影業因包括醜聞在內的多種不利因素身陷泥潭，電影公司巨頭於是尋求手段來為好萊塢爭取正面宣傳，1923年中期在洛杉磯舉行的博覽會就是這樣一種宣傳手段。為了促使國會同意發行紀念幣來為展會籌資，組織員將博覽會與門羅主義100周年聯繫起來，國會於是通過法案，授權製作半美元銀質紀念幣。博覽在成本上入不敷出，硬幣銷售狀況欠佳，共計生產的27萬枚中絕大部分都進入市場流通。貝克指控比奇設計的背面剽竊了他多年前設計的印章，但比奇和另一位雕塑家詹姆斯·厄爾·弗雷澤對此予以否認。以發行價買下的銀幣中又有許多在大蕭條期間消費掉了，大部分現存的這種紀念幣都存在一定程度磨損。\n\n\n', '2020-01-06'),
(2, 'https://picsum.photos/300/300/?random=8', 'admin', '作品no.1', '航空母艦 美國 海軍 韓戰', '漢考克號航空母艦是一艘隸屬於美國海軍的航空母艦，為艾塞克斯級航空母艦的十一號艦。她以漢考克為名，是為了紀念美國獨立宣言第一位簽署人約翰·漢考克。漢考克號在1943年開始建造，1944年服役，開始參與太平洋戰爭。戰後漢考克號退役停放，在韓戰時期進行改建，但改建完後韓戰已經停火。北部灣事件後兩個月，漢考克號開始參與越戰，並多次派飛機到陸上攻擊。此後十一年間，漢考克號一共進行了九次越戰巡航，為美國航空母艦之最。1975年越戰即將結束之際，漢考克號臨時改裝為兩棲突擊艦，參與美國多場撤退行動，在金邊及西貢淪陷前夕，救走多名高棉、南越及美國人員。越戰結束後的翌年，漢考克號從海軍退役除籍，並出售拆解。', '2020-01-06'),
(3, 'https://picsum.photos/300/600/?random=2', 'admin', '作品no.2', '攝影 設計 官方', '作品內文...', '2020-01-06'),
(4, 'https://picsum.photos/300/300/?random=3', 'admin', '作品no.3', '攝影 設計 官方', '作品內文...', '2020-01-06'),
(5, 'https://picsum.photos/300/500/?random=4', 'admin', '作品no.4', '攝影 設計 官方', '作品內文...', '2020-01-06'),
...
(17, 'https://picsum.photos/300/500/?random=15', 'admin', '作品no.4', '攝影 設計 官方', '作品內文...', '0000-00-00'),
(18, 'https://picsum.photos/300/600/?random=16', 'admin', '作品no.5', '攝影 設計 官方', '作品內文...', '0000-00-00');
